...
def time_profile2(S1o_ran,tf_ran,EA_ran,EB_ran,Np_ran,L_ran,A_ran,D1_ran,D2_ran,D3_ran,kA_ran,kB_ran,i):    
    import numpy as np
    ...
    while globalvar.stop != 0 and counter < 4:
        ...
        globalvar.Y10i,globalvar.Y11i,globalvar.Y20i,globalvar.Y21i,globalvar.Y30i,globalvar.Y31i,a1C,a2C,a3C = iv2.I_V_2(counter,L_ran,S1o_ran)
        ...
        plt.legend()
        plt.title('Co-immobilization ci-A/B: Iteration ' + str(i))
        if globalvar.stop == 1: 
