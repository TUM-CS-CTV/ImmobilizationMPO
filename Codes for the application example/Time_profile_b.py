...
in the batch reactor. SID delta'''

def time_profile_b(EA,kA,EB,kB,A,D1,D2,D3,L,S1o,tf,Np,i):    
    import numpy as np
    ...
    while globalvar.stop != 0 and counter < 4:
        ...
        import C_IM2_b as rr2
        import I_V_1_b   as iv2    
    
        globalvar.Y10i,globalvar.Y11i,globalvar.Y20i,globalvar.Y21i,globalvar.Y30i,globalvar.Y31i,a1C,a2C,a3C = iv2.I_V_1(counter,L,S1o)
        ...
        print('S3' ,file = open("ci_BA.txt", "w+"))
        print(sol.y[2,:] ,file = open("ci_BA.txt", "a"))
