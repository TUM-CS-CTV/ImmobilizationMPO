...
in the batch reactor. SID beta'''

def time_profile2(EA,kA,EB,kB,A,D1,D2,D3,L,S1o,tf,Np,i):    
    import numpy as np
    ...
    while globalvar.stop != 0 and counter < 4:
        ...
        counter = counter+1
        pylab.savefig('Co_run{}_'.format(i)+'{}.PNG'.format(counter))
        ...
        print('S3' ,file = open("ci.txt", "w+"))
        print(sol.y[2,:] ,file = open("ci.txt", "a"))
