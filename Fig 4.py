...
ax.clabel(cp2, levels, inline=True, fmt='%1.1f', fontsize=20, manual=[(1.5*10**(-8),3*10**(-8)),(4*10**(-8),3*10**(-8)),(1.75*10**(-7),3*10**(-8))])
